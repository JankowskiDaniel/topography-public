...
import numpy as np
import pandas as pd
from src.data_generation.image._image_details import ImageDetails
...
def generate_balanced_dataset(
    ...
    choosen_noises = np.random.randint(
        0, available_noises, len(epsilons) * n_copies
    )
    ...
    for _epsilon in tqdm(epsilons):
        ...
        for _ in range(n_copies):
            ...
            img = generate_pure_image(_epsilon, size, ring_center, brightness)
